...
import { Sky, SoftShadows, useGLTF } from "@react-three/drei";
...
export function RestaurantSceneComponent({
    ...
    return (
        <div className={styles["restaurant-scene"]}>
            <Canvas shadows={true} camera={{ position: [0, 7, -6], zoom: 2 }}>
...
interface TableProps {
    ...
    auth: UserDto;
    table: ReservableTableDto;
    active: ReservableTableDto;
    setActive: (table: ReservableTableDto) => void;
}
    ...
    return (
        ...
        >
            ...
            <mesh
                ...
                onPointerOver={() => {
                    if (!table.reserved) setHovered(true);
                }}
